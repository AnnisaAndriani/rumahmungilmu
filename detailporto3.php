...
<li class="breadcrumb-item active" aria-current=page>Portofolio Celeste</li>
</ol>
</nav>
</div>
<div class="col-md-6 mb-4 mb-md-0">
<div class=preview-scroll-wrapper>
<img id=previewImage src=assets/img/Screenshot_20-7-2025_214012_localhost.jpeg alt="Preview Blossom" class=preview-img>
</div>
</div>
<div class=col-md-6>
...
<button class="btn btn-outline-danger-custom color-btn active" onclick='changeImage("pink",this)'>Dark Purple</button>
<button class="btn btn-outline-danger-custom color-btn" onclick='changeImage("cyan",this)'>Dark Pink</button>
<button class="btn btn-outline-danger-custom color-btn" onclick='changeImage("lilac",this)'>Dark Lime Green</button>
...
<script>function changeImage(e,s){document.getElementById("previewImage").src={pink:"assets/img/Screenshot_20-7-2025_214012_localhost.jpeg",cyan:"assets/img/Screenshot_20-7-2025_214510_localhost.jpeg",lilac:"assets/img/Screenshot_20-7-2025_215017_localhost.jpeg"}[e],document.querySelectorAll(".color-btn").forEach((e=>e.classList.remove("active"))),s.classList.add("active")}</script>
